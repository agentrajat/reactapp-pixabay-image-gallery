        ...
        <DialogContent>
          <Grid container alignItems='stretch' spacing={1}>
            <Grid item lg={8} md={7} xs={12}>
              <img style={{ maxWidth: "100%" }} src={imageData.largeImageURL} alt="pixabay-img" />
              </Grid>
            <Grid item container lg={4} md={5} xs={12} alignItems='center' direction="column">
              ...
              <Grid item container direction="column" alignItems='center' justifyContent='center' md>
